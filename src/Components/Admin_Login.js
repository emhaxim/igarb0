...
export const Admin_Login = () => {
    ...
    function onSubmit(e) {
        //e.preventDefault();
         ...
         axios.post('http://127.0.0.1:8000/backend/admin-signin/', {
    ...
    <nav className='nav1'  style={{height:"50px"}}>
       ...
       <div  style={{ background : 'white',  overflow: 'hidden'}} > 
            <div className="container"    >
                <div className="row" >
                    <div className="col-lg-4" style={{display:'flex', marginLeft:'-110px', marginTop:'-218px', width:'850px'}}>
                                              ...
                                              <div class="card-front1">
                                                  <div class="center-wrap1">
                                                      <div class="section text-center" style={{backgroundImage:back}}>
                                                       ...
                                                       <i class="fa-solid fa-user" style={{color:"#097969"}}>  </i> Admin<br/>
                                                          Log In
                                                    </h2>
