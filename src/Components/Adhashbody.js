...
const Adhashbody = () => {
  ...
  return (
    <div class="col main pt-5 mt-3" style={{backgroundColor:'#fff'}}>
    ...
    <div class="row mb-3">
        <div class="col-xl-3 col-sm-6 py-2">
            <div class="card bg-success text-white h-100">
                <div class="card-body bg-success" style={{backgroundColor:"#57b960"}}>
                    <div class="rotate">
                       <a  href='#employee' style={{color:'white'}} color='white' backgroundColor='white'> <i class="fa fa-user fa-4x" color='white'></i></a>  
                    </div>
                    <h6 class="text-uppercase">Sweepers</h6>
        ...
        <div class="col-xl-3 col-sm-6 py-2 " >
            <div class="card text-white bg-info h-100" style={{backgroundColor:'#008080'}} >
                <div class="card-body " style={{backgroundColor:'#008080'}}>
                    <div class="rotate">
                     <i class="fa fa-duotone fa-comments fa-4x"></i>
                    </div>
        ...
        <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white  h-100" style={{backgroundColor:'#C70039 '}}>
                <div class="card-body mt-4">
                    <div class="rotate">
                    <i class="fa-solid fa-trash fa-4x"></i>
                    </div>
                    <h6 class="text-uppercase mt-3">Dustbins</h6>
    ...
    <div className='col main pt-3 '>
                    ...
                    <CTable align="middle" class="mb-0 border" hover responsive style={{backgroundColor:"white",height:"600px", width:"1200px"}}>
  ...
  */}
    <div class="row ml-1">
        <div class="col-lg-7 col-md-6 col-sm-12 " >
          <h5 class="mt-3 mb-3" style={{color:"#1DBF73", fontSize:'30px', fontWeight:"bolder"}}>
          ☆ Top five Employees of the month
          </h5>
        ...
        <div className="col-lg-5 col-md-6 col-sm-12 col-sm-offset-5">
            <h4 className='title mt-3 mb-3 text-center text-secondary'>Data in Chart</h4>
             <div className="mb-5 " style={{height:"300px",width:"300px", marginLeft:'90px'}}><PieChart/> </div></div>
    </div>
