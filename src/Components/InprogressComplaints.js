...
function GlobalFilter({
    ...
    return (
        <span>
            <h2 style={{marginTop:"10px", marginBottom:"5px", color:"#1DBF73"}}>Inprogress Complaints</h2>
            <input
...
const InprogressComplaints = () => {
    const columns = React.useMemo(
        () => [
            {
                Header: 'Complain Information Table',
                columns: [
                    {
                        Header: 'Complain ID',
                        accessor: 'firstName',
    ...
    return (
        ...
        <div className="flex-row d-flex">
          ...
          <div className="logo pl-4 ml-1">i<spam style={{color:"#1DBF73", fontWeight:'bold'}} >G</spam>arb<span style={{color:"#1DBF73"}} >0</span></div>
        </div>
