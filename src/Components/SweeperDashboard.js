...
import SweeperSideNav from './SweeperSideNav'

const SweeperDashboard = () => {
    ...
    <div style={{backgroundColor:'white'}}>
       ...
       <nav className="navbar fixed-top navbar-expand-md  mb-3"   style={{backgroundColor:'#43484C', color:"white"}}>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <WidgetsDropdown  style={{backgroundColor:'white', marginTop:'0px'}} />
            <CCard className="mb-4" style={{backroundColor:'white'}}>
                <CCardBody>
                <CRow>
                    <CCol sm={5}>
